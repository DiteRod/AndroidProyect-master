...
public class Forum extends AppCompatActivity implements AsyncResponse{

    TextView titulo, descripcion, result, name;
    EditText comentario;
    String id_posts;
    Button insert, get;
    String insertUrl = "http://192.168.0.11/cursoPHP/insertComment.php";
    String showUrl = "http://192.168.0.11/cursoPHP/showComment.php";
    ...
    public void GetDatos(){
        ServiceManager serviceManager = new ServiceManager(Forum.this,this);
        serviceManager.callService("http://192.168.0.11/cursoPHP/showComment.php");
