...
public class Main extends AppCompatActivity{
    ...
    private EventsFragment eventosFragment;
    private CoursesFragment cursosFragment;
    private ForumFragment foroFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eventosFragment = new EventsFragment();
        cursosFragment = new CoursesFragment();
        foroFragment = new ForumFragment();
